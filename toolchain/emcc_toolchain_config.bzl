                ...
                flag_groups = [
                    flag_group(
                        flags = [
                            ...
                            "-isystem",
                            "external/emscripten/system/include/libc",
                            "-isystem",
                            "external/emscripten/system/lib/libc/musl/arch/emscripten",
                            "-isystem",
                            "external/emscripten/system/local/include",
                        ],
                    ),
                ],
            ),
